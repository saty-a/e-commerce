...
/// Order Status Bar
class OrderDeliveryStatusIndicator extends StatelessWidget {
...
/// Return Delivery Status Indicator
class ReturnOrderStatusIndicator extends StatelessWidget {
  ReturnOrderStatusIndicator(
      {Key? key, required this.orderPicked, required this.refund})
      : super(key: key);
          ...
          children: [
              ...
              children: [
                Stack(
                  children: [
                    ...
                    AnimatedContainer(
                      height: orderPicked == false ? 0.0 : 25.h,
                      width: orderPicked == false ? 0.0 : 25.w,
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        border: Border.all(color: Colors.transparent),
                        color: AppColors.grey100,
            ...
            Row(
              ...
              children: [
                ...
                SizedBox(
                  width: 310.w,
                  child: Text(
                    "Your order #ORD8 return request is approved",
                    style: Styles.tsR14.copyWith(color: AppColors.grey900),
                  ),
                )
              ],
            ...
            Row(
              ...
              children: [
                ...
                26.wb,
                Text(
                  "Order is picked up by delivery boy",
                  style: Styles.tsR14.copyWith(color: AppColors.grey900),
                )
              ],
            ),
            ...
            SizedBox(
              width: 310.w,
              child: Text(
                      "Amount will be refunded within 2 working day in your account",
                      style: Styles.tsR14.copyWith(color: AppColors.grey900))
                  .only(left: 45.w),
            )
          ],
